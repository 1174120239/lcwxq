...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $orderTemplate = $_POST['orderTemplate'];  
    $replyTemplate = $_POST['replyTemplate'];
    $reviewTemplate = $_POST['reviewTemplate'];
    $safetyTemplate = $_POST['safetyTemplate'];
    $verifyTemplate = $_POST['verifyTemplate'];
    $webinfoUrl = $_POST['webinfoUrl'];
    ...
    if (isset($_SESSION['loginadmin']) && $_SESSION['loginadmin'] <> '') {
        ...
        $api_url = $API_EMAIL_TEMPLATE_CONFIG_UPDATE;
        $api_url2 = $API_CONFIG_UPDATE;
        ...
        if ($responseData1['code'] == 1&&$responseData2['code'] == 1) {  
            echo "<script>alert('".$responseData1['msg']."');history.back();</script>";
        } else {
