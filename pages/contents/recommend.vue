<template>
	<view class="userpost" :class="AppStyle">
		...
		<view :style="[{padding:NavBar + 'px 10px 1px 10px'}]"></view>
		<view class="margin-left-sm margin-right-sm margin-top-sm">
			<view class="cu-card article no-card" style="border-radius: 10px;">
