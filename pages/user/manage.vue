<template>
	<view class="user" :class="AppStyle">
		...
		<view class="data-box" v-if="group=='administrator'||group=='editor'">
			...
			<view class="index-sort grid col-2 manage-publish-grid">
				<view class="index-sort-box">
					<waves itemClass="butclass">
						<view class="index-sort-main" @tap="toLink('/pages/user/post')">
							<view class="index-sort-i"><text class="cuIcon-post"></text></view>
							<view class="index-sort-text">发布帖子</view>
						</view>
					</waves>
				</view>
				<view class="index-sort-box">
		...
		<view class="data-box">
			...
			<view class="index-sort grid col-5">
				...
				<view class="index-sort-box" v-if="group=='administrator'">
					<waves itemClass="butclass">
						<view class="index-sort-main" @tap="toLink('/pages/manage/metas?type=tag')">
							<view class="index-sort-i topic-manage-icon">
								<text class="cuIcon-tag"></text>
							</view>
							<view class="index-sort-text">话题管理</view>
						</view>
					</waves>
				</view>
				<view class="index-sort-box">
		...
		<view class="data-box" v-if="group=='administrator'">
			...
			<view class="index-sort grid col-4">
				...
				<view class="index-sort-box" v-if="groupChatEnabled||privateChatEnabled">
					<waves itemClass="butclass">
		...
		<view class="data-box">
			<view class="brandInfo">
				<view class="brandInfo-title">—— 聊一论坛开发组 ——</view>
				<view class="brandInfo-name">qq638978650</view>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		data() {
			return {
				...
				userInfo: null,
				token: "",
				version:this.$API.getAppVersion(),
				allData: {
				      allContents: 0,
				      allComments: 0, 
				      allShop: 0,
...
.topic-manage-icon {
    background: linear-gradient(135deg, #36b37e 0%, #16847c 100%);
}
