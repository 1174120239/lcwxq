<template>
	<view class="campus-subpage campus-agreement-page" :class="{'campus-night': campusNight}">
		...
		<scroll-view scroll-y class="agreement" :style="{height: 'calc(100vh - ' + CustomBar + 'px)'}">
			...
			<view class="agreement-text">5.1使用本服务，您需要注册账号，账号注册成功后，本社区将给予您一个用户账号（本社区号），由您自行设置昵称及相应的密码，该账号和 密码由您负责保管；您应当对通过该账号进行的 所有活动和事件承担全部法律责任。</view>
			<view class="agreement-text">5.2用户账号一经注册，除非子频道要求单 独开通权限，您有权利用该账号使用本社区各个 频道的单项服务，当您使用本社区各单项服务时， 您的使用行为视为其对该单项服务的服务条款以 及本社区在该单项服务中发出的各类公告的同意。</view>
			<view class="agreement-text">5.3本社区号（即本社区用户ID)的所有权归 本社区，您完成注册申请手续后，获得本社区号的 使用权。您应提供真实、详尽及准确的个人资料，并不断更新注册资料，符合真实、详尽、准确的要求。您所有原始键入的资料将引用为注册资料。因 您注册信息不真实而引起一切经济及法律责任， 均由您自行承担，本社区不负任何责任。</view>
			...
			<view class="agreement-text">8.1.3不利用本社区服务从事以下活动：</view>
			...
			<view class="agreement-text">8.2用户违反本协议的规定，给本社区造成 损失，或者导致的任何第三方主张的包括合理的律师费、调查费在内的任何索赔、要求或损失，您同意赔偿本社区与合作公司、关联公司，并使之免受损害。对此，本社区有权视用户的行为性质，采取包括但不限于删除用户发布信息内容、暂停使用许可、终止服务、限制使用、回收本社区账号、追究法律责任等措施。对恶意注册本社区账号或利用本社区账号进行违法活动、捣乱、骚扰、欺骗、其他用户以及其他违反本协议的行为，本社区 有权回收其账号。同时，本社区会视司法部门的要求，协助调查。</view>
			<view class="agreement-text">8.3用户不得对本服务任何部分或本服务之 使用或获得，进行复制、拷贝、出售、转售或用于 任何其它商业目的。</view>
			<view class="agreement-text">8.4用户须对自己在使用本社区服务过程中的行为承担法律责任。用户承担法律责任的形式 包括但不限于：停止侵害行为、对受到侵害者进行赔偿，以及在本社区首先承担了因用户行为导致的行政处罚或侵权损害赔偿责任后，用户应给予本社区等额的赔偿。</view>
			<view class="agreement-title">九、知识产权</view>
			<view class="agreement-text">9.1本社区对根据本服务或经本服务获得的所有信息，包括但不限于文本、图片、视频、音 频、图标、应用、设计、软件、脚本、程序、版权、商标、商号、专利等本社区提供的内容保留所有权利。除非本协议另行约定，否则您对本服务的访问、使用并不构成本服务或其中内容的任何所有权或其它权利向您或其他任何人的转移。</view>
			...
			<view class="agreement-text">9.3本社区尊重他人知识产权和合法权益， 呼吁用户也要同样尊重知识产权和他人合法权 益。若您认为您的知识产权或其他合法权益被侵 犯，请按照以下说明向本社区提供资料：</view>
			<view class="agreement-text">请注意：如果权利通知的陈述失实，权利通知提交者将承担对由此造成的全部法律责任（包括 但不限于赔偿各种费用及律师费）。如果上述个人或单位不确定网络上可获取的资料是否侵犯了其知识产权和其他合法权益，本社区建议该个人或单位首先咨询专业人士。为了本社区有效处理上述个人或单位的权利通知，请使用以下格式（包括各条款的序号）：</view>
			...
			<view class="agreement-text">您同意本社区有权基于其自行之考虑，因任 何理由，包含但不限于长时间未使用，或本社区认为您已经违反本服务协议的文字及精神，终止您的密码、账号或本服务之使用（或服务之任何部分），并将您在本服务内任何内容加以移除并删除。您同意依本注册协议任何规定提供之本服务，无需进行事先通知即可中断或终止，您承认并同意，本社区可立即关闭或删除您的账号及您账号中所有相关信息及文件，及/或禁止继续使用前述文件或本眼务。您已下载到自己可控的指定客户端（设备）上的数据资源，可以继续使用。此外，您同意若本服务之使用被中断或终止或您的账号 及相关信息和文件被关闭或删除，本社区对您或任何第三人均不承担任何责任。</view>
			<view class="agreement-title">十一、一般条款</view>
			<view class="agreement-text">11.1用户明确同意其使用本社区网络服务所 存在的风险将完全由其自己承担。用户理解并接受下载或通过本社区服务取得的任何信息资料取决于用户自己，并由其承担系统受损、资料丟失以 及其它任何风险。本社区对在服务网上得到的任 何商品购物服务、交易进程、招聘信息，都不作担 保。</view>
			<view class="agreement-text">11.2用户须知：本社区提供的各种挖掘推送服务中，推送给用户曾经访问过的网站或资源之链接是基于机器算法自动推出，本社区不对其内容的有效性、安全性、合法性等做任何担保。</view>
			<view class="agreement-text">11.3六个月未登陆的账号，本社区保留关闭的权利。</view>
			<view class="agreement-title">十二、适用法律及管辖</view>
			<view class="agreement-text">本协议适用法律为中华人民共和国法律。您和本社区同意，在合同履行过程中双方如发生纠纷，应协商解决；协商不成的，双方应向协议签订 地有管辖权的人民法院通过诉讼方式解决。</view>
