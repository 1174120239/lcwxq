			...
			<view class="cu-item" v-for="(item,index) in userList" :key="index" @tap="toUserContents(item)">
				...
				<view class="content">
					<view class="text-black">
						...
						<text v-if="item.groupKey=='contributor'||item.groupKey=='administrator'" class="cuIcon-light text-shojo margin-left-xs"></text>
						<!--  #ifdef H5 || APP-PLUS -->
						<!-- block v-if="item.isvip>0">
				...
				<view class="action goUserIndex">
					<view class="bg-shojo padding-xs round">关注</view>
