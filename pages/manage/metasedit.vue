		...
		<form>
			...
			<view class="cu-form-group"  v-if="type=='add'">
				...
				<view class="action">
					...
					<text class="meta-type" :class="metaType=='tag'?'act':''" @tap="metaType='tag'">话题</text>
				</view>
			</view>
			<view class="cu-form-group align-start">
				<view class="title">简介</view>
				<textarea v-model="description" placeholder="请输入分类和话题简介"></textarea>
			</view>
			<view class="cu-form-group margin-top">
...
<script>
	...
	export default {
		...
		onShow(){
			...
			if(res.metaType){
				that.metaType = res.metaType === 'tag' ? 'tag' : 'category';
			}
			if(res.mid){
				that.mid = res.mid;
				that.geMetaInfo();
