		...
		<view class="ads-list">
			<view class="ads-box">
				<view class="ads-main">
					...
					<view class="ads-text">
						在用户下拉帖子列表时，平台将随机推送已有的推流广告列表。您发布的广告将以类似帖子的形式嵌入列表中，并拥有广告标识，在活跃用户浏览帖子时，您的广告将获得充分曝光。<text class="text-red">为了展现效果，建议上传横版图片。</text>
					</view>
			...
			<view class="ads-box">
				<view class="ads-main">
					...
					<view class="ads-text">
						在平台的几个固定的热门区域将随机推送所有的横幅广告列表。您发布的广告将以图片横幅的形式随机显示在平台的固定区域，在部分用户频繁访问的页面区域（如帖子详情页面），将获得良好的引流效果。<text class="text-red">为了展现效果，建议上传横版图片。</text>
					</view>
					<view class="ads-info grid col-3 text-center">
						<view class="ads-num">
