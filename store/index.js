...
import { getCampusThemeMode, isDongchangfuNight, resolveCampusNight } from '@/utils/campusTheme.js'
...
const store = new Vuex.Store({
  state: {
	AppStyle: resolveCampusNight(getCampusThemeMode(), isDongchangfuNight()) ? 'campus-night' : '',
  ...
  mutations: {
	setAppStyle(state, night) {
	  state.AppStyle = night ? 'campus-night' : ''
	},
