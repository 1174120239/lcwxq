...
| [API_USAGE_GUIDE.md](API_USAGE_GUIDE.md) | 前端、脚本、Bot 和接口开发 | 140 个客户端 API 路径及回调/内部路径、参数、响应和新旧端状态 |
...
| [QQBOT_DEPLOYMENT_TUTORIAL.md](QQBOT_DEPLOYMENT_TUTORIAL.md) | 新部署者、转发给使用者 | NapCat、AstrBot、插件安装和首次配置 |
