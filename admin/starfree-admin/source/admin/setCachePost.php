...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $contentCache = $_POST['contentCache'];
    $contentInfoCache = $_POST['contentInfoCache'];
    $CommentCache = $_POST['CommentCache'];
    $userCache = $_POST['userCache'];
    ...
    if (isset($_SESSION['loginadmin']) && $_SESSION['loginadmin'] <> '') {
        ...
        $api_url = $API_SETUP_CACHE;
        $params = array(  
        'usertime' => (int)$usertime,  
        'contentCache' => (int)$contentCache,  
        'contentInfoCache' => (int)$contentInfoCache,  
        'CommentCache' => (int)$CommentCache,  
        'userCache' => (int)$userCache
        );  
